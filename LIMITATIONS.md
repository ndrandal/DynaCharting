...
(DC-L01, DC-L05, DC-L06, DC-L07, DC-L08 — ENC-984 changed files their `Re-check` commands
name — and DC-L10 at `0dbb0a3`). Every command below was executed at the commit its entry stamps, and produced
